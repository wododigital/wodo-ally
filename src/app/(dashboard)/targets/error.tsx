...
export default function TargetsError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex items-center justify-center py-24 px-6">
      <div className="text-center space-y-4 max-w-md">
        ...
        <h2 className="text-lg font-semibold text-text-primary">Failed to load targets</h2>
        <p className="text-sm text-text-secondary">
          An error occurred while loading target data. Please try again.
        </p>
