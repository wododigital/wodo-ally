...
export function FloatingFAB() {
  ...
  const QUICK_ACTIONS: QuickAction[] = [
    ...
    { onClick: () => setShowInvoiceModal(true), label: "Create Invoice", icon: FileText, color: "#6366f1", bg: "rgba(99,102,241,0.1)" },
  ...
  const itemClass = "flex items-center gap-3 pl-4 pr-4 py-2.5 rounded-full text-sm font-semibold text-gray-800 hover:scale-[1.02] transition-all duration-150 whitespace-nowrap";
  const itemStyle = {
